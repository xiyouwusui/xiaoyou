...
class LegacyTextLocalizer {
  ...
  static final Map<String, String> _exactEn = <String, String>{
    ...
    '本地 Alpine 与远程 PC Bridge': 'Local Alpine and remote PC Bridge',
    '微信与 Telegram 消息渠道': 'WeChat and Telegram message channels',
    '加载 IMessage 配置失败': 'Failed to load IMessage settings',
    'Telegram 配置已保存': 'Telegram settings saved',
    '微信配置已保存': 'WeChat settings saved',
    '获取微信二维码失败': 'Failed to get WeChat QR code',
    'IM 会话已清除': 'IM sessions cleared',
    '清除失败': 'Failed to clear',
    '连接状态': 'Connection Status',
    'IM 渠道运行中': 'IM channels running',
    'IM 渠道未运行': 'IM channels not running',
    '隐藏': 'Hide',
    '显示': 'Show',
    '高级设置': 'Advanced Settings',
    '消息分段长度': 'Message Chunk Size',
    '保存 Telegram': 'Save Telegram',
    '微信': 'WeChat',
    'OpeniLink SDK 未打包': 'OpeniLink SDK is not bundled',
    '等待扫码或 Token': 'Waiting for scan or Token',
    '保存微信': 'Save WeChat',
    '扫码绑定': 'Scan to Bind',
    '会话': 'Sessions',
    '清除后会重置当前消息渠道会话上下文':
        'Clearing resets the current message channel session context',
    '未启用': 'Not enabled',
    '已连接': 'Connected',
    '连接中': 'Connecting',
    '未连接': 'Disconnected',
    '微信扫码绑定': 'Bind WeChat by QR Code',
    '已复制': 'Copied',
    '复制绑定内容': 'Copy Binding Content',
    'Bot Token 未配置': 'Bot Token is not configured',
    'Telegram Bot Token 未配置': 'Telegram Bot Token is not configured',
    '当前渠道不支持扫码绑定': 'This channel does not support QR binding',
